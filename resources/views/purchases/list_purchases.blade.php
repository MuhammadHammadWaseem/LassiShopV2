            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-end mb-3">               
                        @can('purchases_add')
                            <a href="/purchase/purchases/create" class="btn btn-outline-primary btn-md m-1"><i
                                            ...
                                            <td>
                                                <div role="group" aria-label="Basic example" class="btn-group">
                                                    ...
                                                    @can('payment_purchases_edit')
                                                        <span title="Edit" class="btn btn-icon btn-success btn-sm"
...
<script type="text/javascript">
    $(function() {
        ...
        //Get Data
        function purchase_datatable(start_date = '', end_date = '', Ref = '', provider_id = '', warehouse_id =
            '', payment_statut = '') {
            ...
            Submit_Payment() {
                this.$refs.Add_payment.validate().then(success => {
                    if (!success) {
                        ...
                        toastr.error(
                        '{{ __('translate.Paying_amount_is_greater_than_Grand_Total') }}');
                        this.payment.montant = 0;
