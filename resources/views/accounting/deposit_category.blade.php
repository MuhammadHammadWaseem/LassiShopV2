...
<div class="breadcrumb">
    <h1>{{ __('translate.Deposit_Category') }}</h1>
</div>

<div class="separator-breadcrumb border-top"></div>

<div class="row" id="section_Deposit_Category">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table id="deposit_category_table" class="display table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('deposit_category')
                                            <a @click="Edit_Category( {{ $category}})" class="cursor-pointer ul-link-action text-success"
    ...
    <div class="modal fade" id="Deposit_Category_Modal" tabindex="-1" role="dialog"
        aria-labelledby="Deposit_Category_Modal" aria-hidden="true">
                    ...
                    <form @submit.prevent="editmode?Update_Category():Create_Category()">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="title">{{ __('translate.Title') }}
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            New_Category() {
                this.reset_Form();
                this.editmode = false;
                $('#Deposit_Category_Modal').modal('show');
            },
            ...
            Create_Category() {
                ...
                axios.post("/accounting/deposit_category", {
                    title: self.category.title,
                }).then(response => {
                        self.SubmitProcessing = false;
                        window.location.href = '/accounting/deposit_category'; 
           ...
           //----------------------- Update Category ---------------------------\\
            Update_Category() {
                var self = this;
                self.SubmitProcessing = true;
                axios.put("/accounting/deposit_category/" + self.category.id, {
                    title: self.category.title,
                }).then(response => {
                        self.SubmitProcessing = false;
                        window.location.href = '/accounting/deposit_category'; 
            ...
            Remove_Category(id) {
                ...
                swal({
                    ...
                    buttonsStyling: false
                        ...
                        axios
                            .delete("/accounting/deposit_category/" + id)
                            .then(() => {
                                window.location.href = '/accounting/deposit_category'; 
...
<script type="text/javascript">
    $(function () {
      "use strict";
        ...
        $('#deposit_category_table').DataTable( {
...
<script>
    document.getElementById("printButton").addEventListener("click", function() {
          var table = document.getElementById("deposit_category_table");
          if (table) {
              // Clone the table
