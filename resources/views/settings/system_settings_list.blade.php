          ...
          <form @submit.prevent="Update_Settings()" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  <label for="delivery_charge">Delivery Charges
                    <span class="field_required">*</span></label>
                  <input type="text" v-model="setting.delivery_charge" class="form-control" name="delivery_charge"
                    id="delivery_charge" placeholder="Delivery Charges" />
                    <span class="error" v-if="errors_settings && errors_settings.delivery_charge">
                      @{{ errors_settings.delivery_charge[0] }}
                    </span>
                  </div>
              ...
              <div class="form-group col-md-4">
                <label for="km">
                  <span class="field_required">How Far Do You Want To delivery</span></label>
                  <br>
                  <input type="text" v-model="setting.km" class="form-control" name="km"
                  id="km" placeholder="km" />
                <span class="error" v-if="errors_settings && errors_settings.km">
                  @{{ errors_settings.km[0] }}
                </span>
              </div>
            </div>
  ...
  Vue.component('v-select', VueSelect.VueSelect)
        ...
        methods: {
           ...
           Update_Settings() {
                ...
                self.data.append("km", self.setting.km);
                self.data.append("delivery_charge", self.setting.delivery_charge);
