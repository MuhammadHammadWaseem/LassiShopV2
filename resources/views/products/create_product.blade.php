                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        {{-- <div class="form-group col-md-4 mb-3">
                            <label>Not Ingrediant<span class="field_required">*</span></label>
                            <input type="checkbox" name="not_ingrediant" id="" v-model.number="not.ingrediant">
            ...
            <div class="card mt-5">
                <div class="card-body">
                    ...
                    <div class="col-md-12 mb-2 d-flex align-items-center justify-content-between">
                        ...
                        <div class="form-check form-check">
                            <label class="checkbox checkbox-primary" for="no_ingredients">
                                <input type="checkbox" id="no_ingredients" v-model="product.no_ingredients"
                                    name="no_ingredients">
                                <span>No Ingredients</span><span class="checkmark"></span>
                            </label>
                        </div>
                    </div>

                    <div class="row mt-3 d-flex align-items-center justify-content-between d-none"
                        id="product_has_no_ingredients">
                        <div class="form-group col-md-4">
                            <label for="warehouse_id">{{ __('translate.Warehouse') }}</label>
                            <select name="warehouse_id" id="warehouse_id" class="form-control" v-model="product.warehouse_id">
                        ...
                        <div class="form-group col-md-4">
                            <label for="online_price">Online Price</label>
                            <input type="text" class="form-control" id="online_price"
                                placeholder="{{ __('Enter_Online_Price') }}" v-model="product.online_price">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="pos_category">Select POS Category</label>
                            <select name="pos_category" id="pos_category" class="form-control" v-model="product.pos_category" >
                                <option value="" disabled selected>Select POS Category</option>
                                @foreach ($posCategory as $pos)
...
<script>
    $(document).ready(function() {
        var noIng = $('#no_ingredients');
        var divNoIngredients = $('#product_has_no_ingredients');

        noIng.on('change', function() {
            if ($(this).is(':checked')) {
                divNoIngredients.addClass('d-flex').removeClass('d-none');
            } else {
                divNoIngredients.addClass('d-none').removeClass('d-flex');
            }
        });
    });
</script>
