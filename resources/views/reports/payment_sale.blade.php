...
<div class="breadcrumb">
    <h1>{{ __('translate.Payments_Sale') }}</h1>
  </div>

  <div class="separator-breadcrumb border-top"></div>
  <div id="section_payment_sale">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="table-responsive">
                <table id="payment_sale_table" class="display table table-hover">
                    <thead>
                        <tr>
                            <th>ID</th>
    ...
    <!-- Modal Filter -->
    <div class="modal fade" id="filter_payment_sale_report_modal" tabindex="-1" role="dialog"
        aria-labelledby="filter_payment_sale_report_modal" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" id="filter_payment_sale_report">
                        @csrf
                        <div class="row">
...
<script type="text/javascript">
    $(function () {
      ...
      $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
                ...
                $('#payment_sale_table').DataTable().destroy();
                 payment_sale_datatable(start_date, end_date, Ref, client_id , payment_method_id,account_id, warehouse_id);
        ...
        //Get Data
        function payment_sale_datatable(start_date ='', end_date ='', Ref ='', client_id ='', payment_method_id ='', account_id ='', warehouse_id=''){
            var $symbol_placement = @json($symbol_placement);
            var table = $('#payment_sale_table').DataTable({
                processing: true,
                serverSide: true,
                "order": [[ 0, "desc" ]],
                'columnDefs': [
                ...
                ajax: {
                    url: "{{ route('get_payment_sale_reports_datatable') }}",
                    data: {
        ...
        $('#Show_Modal_Filter').on('click' , function (e) {
            $('#filter_payment_sale_report_modal').modal('show');
        });


         // Submit Filter
        $('#filter_payment_sale_report').on('submit' , function (e) {
            e.preventDefault();
            ...
            $('#filter_payment_sale_report_modal').modal('hide');
...
<script>
    document.getElementById("printButton").addEventListener("click", function() {
          var table = document.getElementById("payment_sale_table");
          if (table) {
              // Clone the table
