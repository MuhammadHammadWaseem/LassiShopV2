...
<div class="breadcrumb">
    <h1>{{ __('translate.CustomersReport') }}</h1>
</div>
...
<div class="section-client-report">
    <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        <table id="clients_table" class="display table table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>{{ __('translate.Code') }}</th>
                                    <th>{{ __('translate.FullName') }}</th>
                                    <th>{{ __('translate.Total_Sales') }}</th>
        ...
        $(document).ready(function () {
          ...
          clients_datatable();
            ...
            $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
                ...
                clients_datatable(start_date, end_date, warehouse_id);
            ...
            //Get Data
            function clients_datatable(start_date ='', end_date ='' , warehouse_id =''){
                ...
                var table = $('#clients_table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('get_report_clients_datatable') }}",
                        data: {
                    ...
                    footerCallback: function (row, data, start, end, display) {
                        ...
                        var total_sales = api.column(3, { page: 'current' }).data().reduce(function (a, b) {
                        ...
                        var sales_due = api.column(6, { page: 'current' }).data().reduce(function (a, b) {
                            return intVal(a) + intVal(b);
                        }, 0);
                        ...
                        $(api.column(3).footer()).html( total_sales);
                        ...
                        if ($symbol_placement == 'before') {
                            ...
                            $(api.column(6).footer()).html('{{$currency}}' +' '+ numberRenderer(sales_due));
                            ...
                            $(api.column(6).footer()).html(numberRenderer(sales_due)  +' '+ '{{$currency}}');
