...
<div class="breadcrumb">
  <h1>{{ __('translate.Sales_Return') }}</h1>
</div>

<div class="separator-breadcrumb border-top"></div>


<div id="section_sales_return_list">
  <div class="card">
    <div class="card-body">
      <div class="row">
        <div class="col-md-12">
          <div class="text-end mb-3">
            <a class="btn btn-outline-success btn-md m-1" id="Show_Modal_Filter"><i class="i-Filter-2 me-2 font-weight-bold"></i>
              ...
              <button id="printButton" class="btn btn-outline-primary fw-bolder" ><i
  ...
  <!-- Modal Filter -->
  <div class="modal fade" id="filter_sale_return_modal" tabindex="-1" role="dialog"
    aria-labelledby="filter_sale_return_modal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form method="POST" id="filter_sale_return">
            @csrf
            <div class="row">
  ...
  $(function () {
      ...
      $(document).ready(function () {
        ...
        $("#start_date,#end_date").datepicker({
          ...
          //init datatable
          sales_return_datatable();
      });


        //Get Data
        function sales_return_datatable(start_date ='', end_date ='', Ref ='',client_id ='', payment_statut ='',warehouse_id ='',sale_id =''){
        ...
        $('#Show_Modal_Filter').on('click' , function (e) {
            $('#filter_sale_return_modal').modal('show');
        });


         // Submit Filter
        $('#filter_sale_return').on('submit' , function (e) {
            e.preventDefault();
            ...
            sales_return_datatable(start_date, end_date, Ref ,client_id, payment_statut,warehouse_id,sale_id);

            $('#filter_sale_return_modal').modal('hide');
        ...
        $(document).on('click', '.delete', function () {
            var id = $(this).attr('id');
            app.Remove_sale_return(id);
        });

          // event delete sale_return (reload Datatatble)
          $(document).bind('Delete_sale_return', function (e) {
            $('#sales_return_table').DataTable().destroy();
            sales_return_datatable();
        });
...
<script>
  ...
  Vue.component('validation-observer', VeeValidate.ValidationObserver);
        ...
        //---------SMS notification
        Payment_Sell_Return_SMS(id) {
          // Start the progress bar.
          NProgress.start();
          NProgress.set(0.1);
          axios
            .post("/sell_return_payment_send_sms", {
              id: id,
            })
            .then(response => {
    ...
    New_Payment(payment_status , id) {
     ...
     get_data_create(id) {
      axios
        .get("/payment/returns_sale/get_data_create/" + id)
        .then(response => {
    ...
    Edit_Payment(payment) {
      ...
      this.due               = parseFloat(this.sale_return_due) + payment.montant;
      setTimeout(() => {
        // Complete the animation of the  progress bar.
        NProgress.done();
        $('#Add_Payment').modal('show');
     ...
     Get_Payments(id) {
      axios
        .get("/sales-return/returns/sale/payment/" + id)
        .then(response => {
          this.payments = response.data.payments;
          this.sale_return_due = response.data.due;
          this.payment_methods   = response.data.payment_methods;
          this.accounts          = response.data.accounts;
    ...
    Update_Payment() {
      ...
      NProgress.set(0.1);
        ...
        axios
          .put("/payment_returns_sale/" + this.payment.id, {
            sale_return_id: this.sale_return_id,
            date: this.payment.date,
            payment_method_id: this.payment.payment_method_id,
            account_id: this.payment.account_id,
     ...
     Remove_Payment(id) {
        swal({
            ...
            buttonsStyling: false
                ...
                axios
                    .delete("/payment_returns_sale/" + id)
                    .then(() => {
          ...
          swal({
              ...
              buttonsStyling: false
                ...
                axios
                  ...
                  .then(() => {
                    $.event.trigger('Delete_sale_return');
                      toastr.success('{{ __('translate.Deleted_in_successfully') }}');
...
<script>
  document.getElementById("printButton").addEventListener("click", function() {
        var table = document.getElementById("sales_return_table");
        if (table) {
            // Clone the table
