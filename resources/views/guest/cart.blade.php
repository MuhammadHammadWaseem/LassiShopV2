...
@section('content')
    ...
    <head>
        ...
        <meta data-n-head="ssr" data-hid="description" name="description"
            content="Al Majaz - Al Majaz 3, Sharjah, United Arab Emirates; ">
        <meta data-n-head="ssr" data-hid="og-image" property="og:image"
            content="https://dyj6gt4964deb.cloudfront.net/images/ade6ca8d-08d2-4cda-be28-f36e3cc7e58d.jpeg">
    ...
    box-shadow: var(--shadow-0);
       ...
       */
        ...
        <script async="" src="https://static.hotjar.com/c/hotjar-3667283.js?sv=6"></script>
        <script async="" src="https://script.hotjar.com/modules.4bbac2bdc7f1b66d3009.js" charset="utf-8"></script>
        <script charset="utf-8" src="/_nuxt/3089c65.js"></script>
        <script charset="utf-8" src="/_nuxt/8d873e2.js"></script>
        <style type="text/css">
        ...
        <script charset="utf-8" src="/_nuxt/63aebcd.js"></script>
        <style type="text/css">
            .menu-item-list {
                margin-bottom: 32px
            }
                            ...
                            <div class="place-info">
                                <div class="place-info__address">
                                    <div class="place-info__block"><svg xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 256 256" width="16" height="16" fill="currentColor">
                                            <g>
                                    ...
                                    <div class="place-info__block"><svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <g>
                                                ...
                                                href="tel:00971501040995">{{ $setting[0]->CompanyPhone }}</a></span></div>
                                    <!---->
                                </div> <!---->
                            </div>
                                    ...
                                    {{-- @foreach ($cart as $item)
                                        <div class="order-item _in-order order-item--regular">
                                            <div class="order-item-header" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 10px">
                                                ...
                                                <button class="back-button focus" style="padding: 0px 5px 0px 5px; background: #bf1e2e; color: white;" onclick="remove({{ $item['id'] }})">x</button>
                                            </div>
                                            <div class="order-item-footer">
                                                <div class="order-item-price">
                                                    <div class="menu-item-price menu-item-price--small"><span
                                                ...
                                                <div class="order-item-count">
                                                    <div class="order-action order-action--small order-action--value">
                                                        <button class="order-action-button _remove ripple focus"
                                                            id="remove_{{ $item['id'] }}"
                                                            onclick="updateQuantity({{ $item['id'] }})">
                                                            –
                                                        </button> <span class="order-action-count"
                                                            id="count_{{ $item['id'] }}">{{ $item['quantity'] }}</span>
                                                        <button class="order-action-button _add ripple focus"
                                                            id="add_{{ $item['id'] }}"
                                                            onclick="addToCart({{ $item['id'] }}, {{ $item['price'] }}, '{{ $item['name'] }}', '{{ asset('images/products/' . $item['img_path']) }}')">
                                                            +
                                                        </button></div>
                                                </div>
                                            </div>
                    ...
                    $(".order-item-list").append(`
                        <div class="order-item _in-order order-item--regular">
                            <div class="order-item-header" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 10px">
                                ...
                                <button class="back-button focus" style="padding: 0px 5px 0px 5px; background: #bf1e2e; color: white;" onclick="remove(${productId})">x</button>
                            </div>
                            <div class="order-item-footer">
                                <div class="order-item-price">
                                    <div class="menu-item-price menu-item-price--small">
                                        <span class="menu-item-price__current">
                                            <b>${response[productId].price}</b>
                                            <span>{{ $setting[0]->Currency->symbol }}</span>
                                        </span>
                                    </div>
                                </div>
                                <div class="order-item-count">
                                    <div class="order-action order-action--small order-action--value">
                                        <button class="order-action-button _remove ripple focus" id="remove_${productId}" onclick="updateQuantity(${productId}, 'decrease')">–</button>
                                        <span class="order-action-count" id="count_${productId}">${response[productId].quantity}</span>
                                        <button class="order-action-button _add ripple focus" id="add_${productId}" onclick="addToCart(${productId}, ${response[productId].price}, '${response[productId].name}', '${response[productId].img_path}')">+</button>
                                    </div>
                                </div>
                            </div>
                        </div>
