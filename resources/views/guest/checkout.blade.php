                        ...
                        <div class="place-content wrapper">
                            ...
                            <div class="order" selected-menu="[object Object]">
                                ...
                                <div class="order-item-list">
                                        <div class="order-item _in-order order-item--regular">
                                            <div class="order-item-header" style="display: flex; align-items: start; justify-content: space-between; margin-bottom: 10px; flex-direction: row">
                            ...
                            <div class="container mt-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 offset-md-3 d-flex justify-content-center align-items-center mt-3">
                            ...
                            <div class="container position-absolute bottom-0">
                                <div class="row">
                                    <div class="col-md-12 d-flex justify-content-start align-items-center">
                                        <h6 style="margin: 0; padding: 0;">Order Summary</h6>
                                    </div>
...
<script>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $("#name").val(response.guest_order_details.name);
            $("#email").val(response.guest_order_details.email);
            $("#phone").val(response.guest_order_details.phone);
            $("#city").val(response.guest_order_details.city);
            $("#country").val(response.guest_order_details.country);
            $("#address").val(response.guest_order_details.address);

            $("#namePrint").text(response.guest_order_details.name);
            $("#emailPrint").text(response.guest_order_details.email);
            $("#phonePrint").text(response.guest_order_details.phone);
            $("#cityPrint").text(response.guest_order_details.city);
            $("#countryPrint").text(response.guest_order_details.country);
            $("#addressPrint").text(response.guest_order_details.address);
...
function confirmOrder() {
    $.ajax({
        ...
        data: {
            ...
            shipping: {{ $setting[0]->delivery_charge }},
            GrandTotal: $("#total").text(),
            warehouse_id : {{ $setting[0]->warehouse_id }},
            paying_amount : $("#total").text(),
            delivery_charges : {{ $setting[0]->delivery_charge }},
        },
        success: function(response) {
